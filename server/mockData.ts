...
export const mockDestinations: Destination[] = [
  ...
  },
  {
    ...
    budget_range: '₹2,20,000 - ₹3,80,000',
  ...
  },
  {
    ...
    budget_range: '₹3,20,000 - ₹5,40,000',
...
export const mockReviews: Review[] = [
  {
    ...
    destination_id: 'dest-goa',
    rating: 5,
    comment: 'Trippy made planning our anniversary trip to Goa so smooth. The AI recommended a private sunset yacht in South Goa which became our absolute favorite memory! Highly recommended!',
